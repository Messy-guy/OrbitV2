...
use commands::{
    ...
    uninstall_agent_cli, write_project_skill_file, list_local_project_skills, read_workspace_file, write_workspace_file,
    get_workspace_file_diff, get_recent_antigravity_transcript, open_in_external_editor, git_stage_file, git_unstage_file,
...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            list_local_project_skills,
            read_workspace_file,
            write_workspace_file,
            get_workspace_file_diff,
            get_recent_antigravity_transcript,
