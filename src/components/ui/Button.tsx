...
export const Button: React.FC<ButtonProps> = ({
  ...
  const baseStyles = 'inline-flex items-center justify-center font-mono font-medium rounded-xl select-none disabled:opacity-30 disabled:pointer-events-none tracking-tight transition-all duration-140 ease-[cubic-bezier(0.16,1,0.3,1)] focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-white/20';
  ...
  const sizes = {
    xs: 'text-[11px] px-2.5 py-1 gap-1.5 h-7 rounded-lg',
    sm: 'text-[11.5px] px-3.5 py-1.5 gap-2 h-8 rounded-xl',
    md: 'text-xs px-4.5 py-2 gap-2.5 h-9 rounded-xl',
    lg: 'text-[13px] px-5.5 py-2.5 gap-2.5 h-10 rounded-xl font-semibold',
