          ...
          <GlassCard>
            <View style={styles.cardHeader}>
              ...
              <View style={{ flex: 1 }}>
                ...
                <Text style={styles.cardSubtitle}>Device control and sensory feedback</Text>
              </View>
            </View>
            ...
            <View style={styles.toggleRow}>
              <View>
                ...
                <Text style={styles.settingSubtext}>Tactile response on taps and interactions</Text>
              </View>
              <Switch
                value={hapticsEnabled}
                onValueChange={setHapticsEnabled}
                trackColor={{ false: 'rgba(255,255,255,0.1)', true: '#EA580C' }}
                thumbColor="#FFFFFF"
              />
            </View>
            ...
            <View style={styles.toggleRow}>
              <View>
                ...
                <Text style={styles.settingSubtext}>Alerts for task completion and issues</Text>
              </View>
              <Switch
